    ...
    layui.use(['util','form','laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
        ...
        var insTb = table.render({
            ...
            ,cols: [[ //表头
              ...
              ,{field: 'iphone', title: '手机号',align:'center'}
              ...
              ,{field: 'start_time', title: '纬度',align:'center'}
              ,{field: 'end_time', title: '营业起始时间',align:'center'}
              ,{field: 'end_time', title: '营业结束时间',align:'center'}
              ,{field: 'distribution_scope', title: '配送范围 默认为km',align:'center'}
              ,{field: 'updated_at', title: '申请时间',align:'center'}
