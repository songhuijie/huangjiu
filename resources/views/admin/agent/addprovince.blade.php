...
<form class="form-horizontal" id="horizontal" >
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="name" class="form-control" id="inputEmail3" placeholder="昵称"  value=" @if (!empty($data)) {{$data['name']}}  @endif ">
    </div>
  </div>
  ...
  {{--<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">绑定后台用户</label>
    @if(!empty($data)) 
        <div class="col-sm-10">
          <input type="text"  readonly class="form-control" id="inputEmail3" placeholder="电话" value=" {{$data['username']}}">
    ...
    <select class="form-control" name="adminid">
      ...
      @foreach ($list as $key=>$datas )
        @if (empty($data)) 
            <option value="{{$datas['id']}}" >{{$datas['username']}}</option>
        @else

            @if ($datas['id'] == $data['adminid']  )
                <option value="{{$datas['id']}}" selected>{{$datas['username']}}</option>
            @else
                <option value="{{$datas['id']}}" >{{$datas['username']}}</option>
            @endif
        @endif
  ...
  <div class="form-group">
   ...
   <div class="form-group" id="list">
    <label for="inputEmail3" class="col-sm-2 control-label">代理级别</label>
        @if (!empty($data))
            <label class="radio-inline">
              <input type="radio" onclick="radiopid(this)" name="isdisplay" @if ($data['isdisplay'] == 1) checked  @endif id="inlineRadio1" value="1"> 市级代理商
            </label>
            <label class="radio-inline">
              <input type="radio" onclick="radiopid(this)"  name="isdisplay" @if ($data['isdisplay'] == 0) checked  @endif  id="sheng" value="0"> 省级代理商
            </label>

        @else
            <label class="radio-inline">
              <input type="radio" onclick="radiopid(this)" name="isdisplay" checked id="inlineRadio1" value="1">市级代理商
            </label>
            <label class="radio-inline">
              <input type="radio" onclick="radiopid(this)" name="isdisplay" id="inlineRadio2" value="0">省级代理商
            </label>
        @endif
  </div>

<div class="form-group" id="pid" >
    <label for="inputPassword3" class="col-sm-2 control-label">上级(即市级代理上级省级代理)</label>
    <select class="form-control" name="pid">
         @if (empty($data)) 
            <option value="0" selected>请选择</option>
         @endif
      @foreach ($ylist as $key=>$datas )
        @if (empty($data)) 
            <option value="{{$datas['id']}}" >{{$datas['username']}}</option>
        @else
            @if ($datas['id'] == $data['pid']  )
                <option value="{{$datas['id']}}" selected>{{$datas['username']}}</option>
            @else
                <option value="{{$datas['id']}}" >{{$datas['username']}}</option>
            @endif
  ...
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">代理账号</label>
    <div class="col-sm-10">
      <input type="text" name="username" class="form-control" id="inputEmail3" placeholder="账号"  value=" @if (!empty($data)) {{$datas['username']}}  @endif ">
    </div>
  </div>

  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">代理密码</label>
    <div class="col-sm-10">
      <input type="text" name="password" class="form-control" id="inputEmail3" placeholder="密码" value="">
      <p>修改直接填写，不修改不填写</p>
    </div>
  </div>
