...
<body>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading clearfix">
                            团队
                            <a href="{{url('agent/additem')}}" class="btn btn-success pull-right"  >添加团队</a>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                            ...
                                            <a href="{{url('agent/teammember')}}?type=select&id={{$item['id']}}"
                                             >查看团队人员</a>
                                        </td>
                                    </tr>
                                   @endforeach
    ...
    function edit(obj){
        var id=obj.id;
        location.href = "{{url('agent/additem')}}?type=edit&id="+id;
