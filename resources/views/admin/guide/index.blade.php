...
<body>
                            ...
                            <div class="layui-inline">
                             ...
                             <div class="layui-inline">
                                <select name="typeid" lay-verify="">
                                  ...
                                  <option value="1">精选定制</option>
                                  <option value="2">主题定制</option>
                                </select>  
                            </div>   
    ...
    layui.use(['util','form','laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
        ...
        var insTb = table.render({
            elem: '#demo'
            ,height: 800
            ,url: '{{URL("guide/index")}}?type=select' //数据接口
            ,title: '标签表'
            ,page: true //开启分页
            ...
            ,cols: [[ //表头
              ...
              ,{field: 'name',title: '技师姓名', width:80,align:'center'}
              ,{field: 'price', title: '定制价格', width:100,align:'center'}
              ...
              ,{ title: '头像', width:100,align:'center',toolbar:'#headimg'}
              ,{field: 'language', title: '语言能力', width:100,align:'center'}
              ,{ title: '类型', width:100,align:'center',toolbar:'#typeDemo'}
              ,{field: 'type_name',title: '类型分类标签', width:100,align:'center'}
              ,{field: 'gradename',title: '等级', width:100,align:'center'}
              ,{ title: '是否可预约', width:100,align:'center',toolbar:'#appointment'}
              ,{field: 'destination', title: '擅长目的地', width:100,align:'center'}
              ,{ title: '状态', width:80,align:'center', toolbar: '#staDemo'}
            ...
            switch(obj.event){
              case 'add':
                layer.open({
                  ...
                  type: 2, 
                  area: ['500px', '400px'],
                  content: '{{url("guide/detail")}}' //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
                }); 
                //layer.msg('添加');
              break;
              case 'update':
                if(data.length === 0){
                  ...
                  layer.open({
                      ...
                      type: 2, 
                      area: ['500px', '400px'],
                      content: '{{url("guide/detail")}}?type=edit&id='+data[0].id
            ...
            if(layEvent === 'detail'){
              layer.msg('查看操作');
               ...
               layer.open({
                  ...
                  type: 2, 
                  area: ['1000px', '800px'],
                  content: '{{url("guide/detail")}}?type=edit&id='+obj.data.id //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
