...
<body>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading clearfix">
                            机构
                            <a href="{{url('mechanism/adddetails')}}" class="btn btn-success pull-right"  >添加机构</a>
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        <td>{{$item['id']}}</td>
                                        <td>{{$item['name']}}</td>
                                        <td><img src=" {{config('url')}}{{$item['img']}}"></td>
                                        <td>{{$item['mechanname']}}</td>
                                        ...
                                        <td class="center">
                                            ...
                                            <a onclick="select(this)" id="{{$item['id']}}" >查看推广人员</a>
                                        </td>
                                    </tr>
                                   @endforeach
    ...
    function select(obj){
        var id=obj.id;
        location.href = "{{url('mechanism/extension')}}?id="+id;
    }
    </script>
