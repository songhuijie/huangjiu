...
<form class="form-horizontal" id="horizontal" action="{{ URL('mechanism/adddetails') }}" method="POST" enctype="multipart/form-data">

  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">机构名称</label>
    <div class="col-sm-10">
      <input type="text" name="mechanname" class="form-control" id="inputEmail3" placeholder="机构名称"  value=" @if (!empty($data)) {{$data['mechanname']}}  @endif">
    </div>
  </div>
   <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">结算比列</label>
        <div class="col-sm-10">
          <input type="text" name="settlementratio" class="form-control" id="inputEmail3" placeholder="服务时间" value=" @if (!empty($data)) {{$data['settlementratio']}}  @endif">
    </div>
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">推广佣金比列</label>
    <div class="col-sm-10">
      <input type="text" name="percentage" class="form-control" id="inputEmail3" placeholder="推广佣金" value=" @if (!empty($data)) {{$data['percentage']}}  @endif">
    </div>
  </div>
   ...
   <div class="form-group">
            ...
            <div class="address">
             ...
             <table width="100%" border="0" cellspacing="0"  cellpadding="0"> 
               <tbody>
                <tr> 
                     <td> 
                      ...
                      <select id="province" name="province" onchange="doProvAndCityRelation();"> 
                            @if(!empty($address))
                                <option id="choosePro" >{{$address[0]}}</option>
                            @else
                ...
                <tr> 
                 <td> 
                    <select id="citys" name="city" onchange="doCityAndCountyRelation();">
                          @if(!empty($address))
                                <option id="chooseCity" >{{$address[1]}}</option>
                          @else
                ...
                <tr> 
                     <td> 
                        <select id="county" name="county" onchange="doCountyAndCountyRelation();">
                             @if(!empty($address))
                                <option id="chooseCounty" >{{$address[1]}}</option>
                             @else
    ...
    <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">选择推广人员</label>
        <div class="col-sm-10">
            @foreach ($promoters as $key =>$item )
                @if(!empty($item['ceshi']))
                 <input type="checkbox" value="{{$item['id']}}" checked name="extension[]">{{$item['name']}}
                @else
                    <input type="checkbox" value="{{$item['id']}}"  name="extension[]">{{$item['name']}}
                @endif
            @endforeach
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" name="contac" class="form-control"  placeholder="联系人" value=" @if (!empty($data)) {{$data['contac']}}  @endif">
        </div>
      </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" name="phone" class="form-control"  placeholder="联系电话" value=" @if (!empty($data)) {{$data['phone']}}  @endif">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" name="contactaddress" class="form-control"  placeholder="联系电话" value=" @if (!empty($data)) {{$data['contactaddress']}}  @endif">
        </div>
    </div>

    <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">商户地址-经纬度</label>
        <div class="col-sm-10">
          <input type="text" name="longitude" class="form-control" id="longitude" placeholder="商户地址-经度" value=" @if (!empty($data)) {{$data['longitude']}}  @endif">
          <input type="text" name="latitude" class="form-control" id="latitude" placeholder="商户地址-纬度" value=" @if (!empty($data)) {{$data['latitude']}}  @endif">
        </div>
    </div>

     <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">机构账户</label>
        <div class="col-sm-10">
          <input type="text" name="username" class="form-control" id="inputEmail3" placeholder="机构账户" value=" @if (!empty($data)) {{$data['username']}}  @endif">
    </div>
    @if(!empty($data))
         <input type="text" name="adminid" hidden value="{{$data['adminid']}}">
    @endif
    <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">机构密码</label>
        <div class="col-sm-10">
          <input type="password" name="password" class="form-control"  placeholder="机构密码" value="">
            <p>修改直接填写，不修改不填写</p>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" name="servicetime" class="form-control" id="inputEmail3" placeholder="服务时间" value=" @if (!empty($data)) {{$data['servicetime']}}  @endif">
    </div>
  ...
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">机构图片</label>
    <div class="col-sm-10">
        <input type="file" class="file" id="file"  name="imgpreview" onchange="imgPreview(this)" >
        <img src="@if (!empty($data)) {{$data['img']}} @endif "   name="img" id="preview">
    ...
    <script>
        $(document).ready(function() {
            ...
            /*$("#img-upload").on('submit',function(e){
                ...
                e.preventDefault();
                var formData = new FormData($(".form-horizontal"));
                $.ajax({
                  
                    type: 'POST',
                    url: "{{url('mechanism/adddetails')}}" ,
                    data: formData ,
                    processData:false,
            ...
            /*$("#sub").click(function(){
                ...
                form.img=$("#preview")[0].src;
                
                if(!isBase64(form.img)){
                    alert('请上传图片');return;
                }
       ...
       function imgPreview(fileDom){
        ...
        let Src = "data:image/xxx;base64,xxxxxx...";
...
function doCountyAndCountyRelation(){
    // console.log($('select[name="province"]').get(0).selectedIndex);
    // console.log($('select[name="province"]').find("option:selected").text());
    var province=$('select[name="province"]').find("option:selected").text();
    var city=$('select[name="city"]').find("option:selected").text();
    var county=$('select[name="county"]').find("option:selected").text();

    var address=province+'-'+city+'-'+county;
   
    $(".address").append(" <input name='address' hidden type='text' value='" + address + "'>");

    // console.log($('select[name="province"]').html());
}
