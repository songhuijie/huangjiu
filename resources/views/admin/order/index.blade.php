...
<script>
    ...
    layui.use(['util','form','laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
        ...
        var insTb = table.render({
            elem: '#demo'
            ,height: 800
            ,url: '{{URL("order/order")}}?type=select' //数据接口
            ,title: '标签表'
            ,page: true //开启分页
            ...
            ,cols: [[ //表头
                ...
                ,{field:'order_delivery',title: '送货方式', width:100,align:'center',templet:function(d){
                ...
                ,{field: 'updated_at', title: '加入时间', width:180,align:'center',
                    templet: function (d) {
            ...
            switch(obj.event){
                case 'add':
                    layer.open({
                        ...
                        type: 2,
                        area: ['80%', '80%'],
                        content: '{{url("order/detail")}}' //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
                    });
                    //layer.msg('添加');
                    break;
                case 'update':
                    if(data.length === 0){
                        ...
                        layer.open({
                            ...
                            type: 2,
                            area: ['500px', '400px'],
                            content: '{{url("order/detail")}}?type=edit&id='+data[0].id
