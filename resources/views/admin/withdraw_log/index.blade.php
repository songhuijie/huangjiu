...
<body>
    ...
    layui.use(['util','form','laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
        ...
        var insTb = table.render({
            elem: '#demo'
            ,height: 800
            ,url: '{{URL("withdraw/index")}}?type=select' //数据接口
            ,title: '标签表'
            ,page: true //开启分页
            ...
            ,cols: [[ //表头
              ...
              ,{field: 'withdraw_type', title: '提现类型', align:'center',templet:function(d){
              ...
              ,{field: 'surplus_amount', title: '当前提现剩余金额', align:'center'}
              ...
              ,{field: 'withdraw_time', title: '提现时间', width:180,align:'center',
                templet: function (d) {
                  return layui.util.toDateString(d.withdraw_time * 1000, "yyyy-MM-dd HH:mm:ss")
                }
              }
            ...
            switch(obj.event){
              case 'add':
                layer.open({
                  ...
                  type: 2, 
                  area: ['500px', '400px'],
                  content: '{{url("withdraw/detail")}}' //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
                }); 
                //layer.msg('添加');
              break;
              case 'update':
                if(data.length === 0){
                  ...
                  layer.open({
                      ...
                      type: 2, 
                      area: ['500px', '400px'],
                      content: '{{url("withdraw/detail")}}?type=edit&id='+data[0].id
            ...
            if(layEvent === 'detail'){
              layer.msg('查看操作');
               ...
               layer.open({
                  ...
                  type: 2, 
                  area: ['500px', '400px'],
                  content: '{{url("withdraw/detail")}}?type=edit&id='+obj.data.id //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
